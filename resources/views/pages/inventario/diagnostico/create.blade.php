    ...
    <div class="col-xl-11 order-xl-1 py-5">
        <div class="card bg-white contenedor">
            ...
            <div class="card-body">
                ...
                <form method="post" id="form-alert" action="{{ route('diagnostico.store', ['id' => $id, 'tabla' => $tabla]) }}" autocomplete="off">
                    @csrf

                    <div class="pl-lg-3">
                        <div class="form-group">
                            <label class="form-control-label">{{ __('Descripción del diagnostico') }}</label>
                            <input type="text" name="descripcion" class="form-control" placeholder="{{ __('Nombre') }}" autofocus value="{{ old('descripcion') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="fecha" class="form-control" placeholder="{{ __('AAAA-MM-DD') }}" autofocus value="{{ old('fecha') }}">
                            @if ($errors->has('fecha'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="observaciones" id="input-observaciones" class="form-control" placeholder="{{ __('Observaciones del recurso') }}" value="{{ old('observaciones') }}" autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="acciones" id="input-acciones" class="form-control" placeholder="{{ __('Acciones del recurso') }}" value="{{ old('acciones') }}" autofocus>
