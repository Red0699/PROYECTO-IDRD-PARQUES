...
'description' => __('Editar información de perfil'),
'class' => 'col-lg-12'
])
                    ...
                    <div class="card-body pt-0 pt-md-4">
                        ...
                        <div class="text-center">
                            ...
                            <div class="h5 font-weight-300">
                                <i class="ni location_pin mr-2"></i>{{ __('Bogotá, Cundinamarca') }}
                            </div>
                            <div class="h5 mt-4">
                                <i class="ni business_briefcase-24 mr-2"></i>{{ __('Solution Manager - Creative Tim Officer') }}
                            </div>
                            <div>
                                <i class="ni education_hat mr-2"></i>{{ __('Instituto Distrital de Recreación y Deporte') }}
                            </div>
                            <hr class="my-4" />
                            <h6 class="heading-small text-muted mb-4 text-left">{{ __('Cargar Foto') }}</h6>

                            <div class="form-group">
                                <input type="file" name="photo" class="form-control" value="{{isset(auth()->user()->photo)?auth()->user()->photo:''}}" id="photo">
                            </div>

                            <h7>{{ __('JPG o PNG de no más de 5 MB') }}</h7>
                    ...
                    <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                        ...
                        <div class="pl-lg-4">
                            <div class="form-group{{ $errors->has('old_password') ? ' has-danger' : '' }}">
                                ...
                                <input type="password" name="old_password" id="input-current-password" class="form-control form-control-alternative{{ $errors->has('old_password') ? ' is-invalid' : '' }}" placeholder="{{ __('Ingrese aqui la contraseña actual') }}" value="" required>
                            ...
                            <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                                ...
                                <input type="password" name="password" id="input-password" class="form-control form-control-alternative{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="{{ __('Ingrese aqui la nueva contraseña') }}" value="" required>
